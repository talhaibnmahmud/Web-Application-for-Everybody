                ...
                <?php
                    ...
                    if($edu_count) {
                        foreach($edu as $ed) {
                            ...
                            //Setting the input values for education
                            echo '<div id = "edu'.$countEdu.'">';
                            echo '<p>Year: ';
                            echo '<input type="text" name="edu_year'.$countEdu.'" value="'.$ed['year'].'" />';
                            echo '<input type="button" value="-" onclick="$(\'#edu'.$countEdu.'\').remove();return false;"><br>';
                            echo '</p>';
                            echo '<p>School: ';
                            echo '<input type="text" size="80" name="edu_school'.$countEdu.'" class="school" value="'.$institution.'" />';
                            echo '</p>';
                            echo '</div>';
                        }
                    }
                ...
                <?php
                    ...
                    if($count) {
                        foreach($rows as $ro) {
                            ...
                            //Setting the input values for position
